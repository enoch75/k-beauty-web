const LANGUAGES = {
    ko: {
        ...
        "email-label": "📧 시스템 발송용 이메일 주소 (필수)",
        "email-desc": "결제 즉시 해당 이메일로 노션 접속 권한이 발송됩니다.",
        "email-alert": "⚠️ 이메일 주소를 먼저 입력해 주세요.",
        "value-title": "가격을, 서류를, 소통을 '서면으로' 확인하는 시스템",
        "value-list1": "항목별 서면 견적 요구 템플릿",
        "value-list2": "진료 / 추가 옵션 확인용 회화 스크립트",
        "value-list3": "통증 표현 DB + K-뷰티 전문 용어 사전",
        "value-old-price": "기존 가격 $78.00",
        "value-new-price-desc1": "단 1회 영구 결제",
        "value-new-price-desc2": "✨ 평생 무료 업데이트 포함",
        "toc-title": "📦 시스템 수록 콘텐츠 (목차)",
        "toc-1": "Part 1. 진실 (업계의 현실과 방어)",
        "toc-2": "Part 2. 생존 사전 (K-Beauty 용어)",
        "toc-3": "Part 3. 청사진 (7일 간의 타임라인)",
        "toc-4": "Part 4. 검증된 병원 20곳 (검증 DB)",
        "toc-5": "Part 5. 핵심 통증 사전 (증상 DB)",
        "toc-6": "Part 6. 생존 회화 DB (📱 손가락으로 짚고 말하기)",
        "cta-main-text": "👇 지금 바로 접속하기",
        "cta-sub-text": "(즉시 열람 · 모바일 최적화 · 템플릿 포함)",
        "legal-1": "본 서비스는 의료행위를 제공하지 않으며, 수술 결과·부작용 0을 보장하지 않습니다.",
        "legal-2": "최종 비용·치료 계획은 의료기관의 진료 및 정책에 따릅니다.",
        "legal-3": "업데이트는 서비스 운영 정책에 따라 제공됩니다.",
        "hotel-tier-label": "예상 숙박 등급",
        "hotel-budget": "3성급 이하 (가성비)",
        "hotel-standard": "4성급 (표준)",
        "hotel-premium": "5성급 (프리미엄)",
        "stay-duration-label": "예상 체류 기간",
        "stay-short": "3~5일 (간단한 쁘띠 시술)",
        "stay-medium": "1주일 (일반 수술)",
        "stay-long": "2주일 이상 (대형 수술/복합 수술)",
        "translator-label": "통역/케어 서비스",
        "trans-none": "필요 없음 (직접 해결 가능)",
        "trans-basic": "병원 동행 통역만 필요",
        "trans-full": "공항 픽업 및 전일정 케어",
        "budget-fair-label": "강남 예상 평균 시세 (내국인 기준)",
        "budget-ripoff-label": "외국인 프리미엄 (브로커 수수료 등)",
        "advice-alert": "🚨 바가지 주의보",
        "advice-alert-desc": "이 시뮬레이션에 따르면, 약 <b>${diff}</b> 만큼의 부당한 브로커 비용이나 외국인 프리미엄이 추가되었을 위험이 매우 높습니다.",
        "budget-hotel-label": "🏠 예상 숙박 비용",
        "budget-trans-label": "🗣️ 예상 통역/동행 비용",
        "budget-total-label": "예상 총 예산",
        "btn-upsell-fair": "이 가격이 맞는지 검증된 병원 DB(20선) 받기 - 단 $49"
    },
    en: {
        ...
        "email-label": "📧 Email Address for System Delivery (Required)",
        "email-desc": "Your Notion access link will be sent to this email immediately after payment.",
        "email-alert": "⚠️ Please enter your email address first.",
    ...
    zh: {
        ...
        "email-label": "📧 用于接收系统的电子邮箱地址（必填）",
        "email-desc": "付款后，Notion 访问权限将立即发送到该电子邮箱。",
        "email-alert": "⚠️ 请先输入您的电子邮箱地址。",
    ...
    ja: {
        ...
        "email-label": "📧 システム受信用メールアドレス（必須）",
        "email-desc": "決済完了後、即座にこちらのメールへNotionアクセス権限が送信されます。",
        "email-alert": "⚠️ 先にメールアドレスを入力してください。",
    ...
    th: {
        ...
        "email-label": "📧 ที่อยู่อีเมลสำหรับการจัดส่งระบบ (จำเป็น)",
        "email-desc": "สิทธิ์การเข้าถึง Notion จะถูกส่งไปยังอีเมลนี้ทันทีหลังชำระเงิน",
        "email-alert": "⚠️ กรุณาระบุที่อยู่อีเมลของคุณก่อน",
    ...
    vi: {
        ...
        "email-label": "📧 Địa chỉ Email nhận Hệ thống (Bắt buộc)",
        "email-desc": "Quyền truy cập Notion sẽ được gửi đến email này ngay sau khi thanh toán.",
        "email-alert": "⚠️ Vui lòng nhập địa chỉ email của bạn trước.",
